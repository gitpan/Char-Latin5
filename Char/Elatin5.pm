...
=item Make character
  ...
  set. For example, Char::Elatin5::chr(65) is "A" in either ASCII or Latin-5, not Unicode,
  and Char::Elatin5::chr(0x82a0) is a Latin-5 HIRAGANA LETTER A. For the reverse of
  Char::Elatin5::chr, use Char::Latin5::ord.
