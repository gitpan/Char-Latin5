...
# split
            ...
            my $e_string = 'Char::Elatin5::split';
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # /i modifier
        elsif ($ignorecase and (Char::Elatin5::uc($char[$i]) ne Char::Elatin5::lc($char[$i]))) {
...
and the cellular phone. This software treats Latin-5 directly. Therefor there is
not UTF8 flag.
...
=item * Possible to handle raw Latin-5 values

=item * Backward compatibility of data, script and how to

=item * Only Char/Latin5.pm and Char/Elatin5.pm, other modules are unnecessary
...
functions.
  ...
  ---------------------------------
  lc          Char::Elatin5::lc
  lcfirst     Char::Elatin5::lcfirst
  uc          Char::Elatin5::uc
  ucfirst     Char::Elatin5::ucfirst
  chr         Char::Elatin5::chr
  glob        Char::Elatin5::glob
  ---------------------------------
...
Char/Latin5.pm remove 'bytes::' at head of function name.
...
=head1 Perl5.6 Emulation on perl5.005
  ...
  --------------------------------------------------------------------
  Before          After                  in BEGIN { } of Char/Elatin5.pm
  --------------------------------------------------------------------
  binmode(...);   Char::Elatin5::binmode(...);   *CORE::GLOBAL::binmode = ...
  open(...);      Char::Elatin5::open(...);      *CORE::GLOBAL::open    = ...
  --------------------------------------------------------------------
...
=item * binmode (Perl5.6 emulation on perl5.005)
  ...
  * two arguments
  ...
  If you are using perl5.005, Char::Latin5 software emulate perl5.6's binmode function.
...
=item * open (Perl5.6 emulation on perl5.005)
  ...
  * three arguments
  ...
  If you are using perl5.005, Char::Latin5 software emulate perl5.6's open function.
  ...
  open(FH, "<:crlf:encoding(Char::Latin5)", $path) or die "can't open $path: $!";
...
=head1 Ignore utf8 pragma
  ...
  ---------------------------------------------------------------------
  use utf8;       # use utf8;            Char/Elatin5.pm provides utf8::*
  no utf8;        # no utf8;             functions even if 'no utf8;'
  use bytes;      # use bytes;           Char/Elatin5.pm provides bytes::*
...
page 402 of Programming Perl, 3rd ed. again.
  ...
  Information processing model beginning with this software
    ...
    +-----------------------------------+
    |      ASCII Compatible Encoding    | ex. Latin-5
    +-----------------------------------+
                (No UTF8 Flag)
...
I am thankful to all persons.
 ...
 http://search.cpan.org/dist/Latin-5-Regexp/
