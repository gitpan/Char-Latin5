...
# subroutines of package Char::Elatin5
...
=head1 Un-Escaping bytes::* Subroutines (Char/Latin5.pm provides)

Char/Latin5.pm removes 'bytes::' at head of subroutine name.
