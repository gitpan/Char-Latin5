...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                for (@list) {
                    $Char::Elatin5::function_ord     = 'Char::Latin5::ord'     if /\A ord \z/oxms;
                    $Char::Elatin5::function_ord_    = 'Char::Latin5::ord_'    if /\A ord \z/oxms;
                    $Char::Elatin5::function_reverse = 'Char::Latin5::reverse' if /\A reverse \z/oxms;
                    $Char::Elatin5::function_getc    = 'Char::Latin5::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }

    $e_script .= Char::Latin5::escape();
...
=head1 Calling 'Char::Elatin5::ignorecase()' (Char::Latin5 software provides)

Char::Latin5 software applies calling 'Char::Elatin5::ignorecase()' instead of /i modifier.
...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Char::Latin5 software provides)

Char::Latin5 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Char::Latin5 software provide)
...
=head1 Un-Escaping bytes::* Subroutines (Char::Latin5 software provides)

Char::Latin5 software removes 'bytes::' at head of subroutine name.
...
some bugs. Thus, if you happen to find a bug that's in Char::Latin5 software and
