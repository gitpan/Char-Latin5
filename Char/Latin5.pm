...
######################################################################
#
# Char::Latin5 - Source code filter to Latin-5 script
#
...
sub Char::Latin5::escape_script {
    ...
    if (/^ use Char::Elatin5(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        $e_script .= sprintf("use Char::Elatin5 %s;\n%s", $Char::Elatin5::VERSION, $use_re_eval); # require run-time routines version
...
Char::Latin5 - Source code filter to escape Latin-5

=head1 SYNOPSIS

  use Char::Latin5;
  use Char::Latin5 version;         --- require version
