...
10% everything else. But this "text" means US-ASCII text, and popular Latin-5
...
Perl3 or later can treat Latin-5.

Perl is designed to make the easy jobs easy, without making the hard jobs
impossible. Char::Latin5 software is Perl program designed to make the "easy jobs easy".
...
=item * Handles Raw Latin-5, Doesn't use UTF8 flag like JPerl
...
It has already been achieved by Latin-5 designed for combining with
...
Contrasting is Encode module and describing "use Char::Latin5;" on this software,
