...
=item Make character
  ...
  set. For example, Elatin5::chr(65) is "A" in either ASCII or Latin-5, not Unicode,
  and Elatin5::chr(0x82a0) is a Latin-5 HIRAGANA LETTER A. For the reverse of
  Elatin5::chr, use Latin5::ord.
