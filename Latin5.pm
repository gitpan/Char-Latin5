...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Latin5 software provides)

Latin5 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Latin5 software provide)
