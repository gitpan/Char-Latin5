...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # /i modifier
        elsif ($ignorecase and (Elatin5::uc($char[$i]) ne Elatin5::lc($char[$i]))) {
            $char[$i] = '[' . Elatin5::uc($char[$i]) . Elatin5::lc($char[$i]) . ']';
        }
...
=item * Only Latin5.pm and Elatin5.pm, other modules are unnecessary
...
functions.
  ...
  ---------------------------------
  lc          Elatin5::lc
  lcfirst     Elatin5::lcfirst
  uc          Elatin5::uc
  ucfirst     Elatin5::ucfirst
  chr         Elatin5::chr
  glob        Elatin5::glob
  ---------------------------------
...
Latin5.pm remove 'bytes::' at head of function name.
...
=head1 Perl5.6 Emulation on perl5.005
  ...
  --------------------------------------------------------------------
  Before          After                  in BEGIN { } of Elatin5.pm
  --------------------------------------------------------------------
  binmode(...);   Elatin5::binmode(...);   *CORE::GLOBAL::binmode = ...
  open(...);      Elatin5::open(...);      *CORE::GLOBAL::open    = ...
  --------------------------------------------------------------------
...
=item * binmode (Perl5.6 emulation on perl5.005)
  ...
  * two arguments
  ...
  If you are using perl5.005, Latin5 software emulate perl5.6's binmode function.
...
=item * open (Perl5.6 emulation on perl5.005)
  ...
  * three arguments
  ...
  If you are using perl5.005, Latin5 software emulate perl5.6's open function.
  ...
  open(FH, "<:crlf:encoding(Latin5)", $path) or die "can't open $path: $!";
...
=head1 Ignore utf8 pragma
  ...
  ---------------------------------------------------------------------
  use utf8;       # use utf8;            Elatin5.pm provides utf8::*
  no utf8;        # no utf8;             functions even if 'no utf8;'
  use bytes;      # use bytes;           Elatin5.pm provides bytes::*
